...
private:
    char couleurPiece;                              // Couleur de la Piece.
    virtual bool canMove(int ligneSource, int colSource, int ligneDestination, int colDestination, Case* echiquier[8][8]) = 0;  // La méthode canMove(), abstraite dans la classe Piece.
};
...
private:
    bool canMove(int ligneSource, int colSource, int ligneDestination, int colDestination, Case* echiquier[8][8]);  // Vérifie si le Roi peut move dans une case de l'échiquier, prend en paramètres les coordonnées de départ et les coordonnées d'arrivé, et l'échiquier.
};
...
private:
    bool canMove(int ligneSource, int colSource, int ligneDestination, int colDestination, Case* echiquier[8][8]);  // Vérifie si le Chevalier peut move dans une case de l'échiquier, prend en paramètres les coordonnées de départ et les coordonnées d'arrivé, et l'échiquier.
};
...
private:
    bool canMove(int ligneSource, int colSource, int ligneDestination, int colDestination, Case* echiquier[8][8]);  // Vérifie si la Tour peut move dans une case de l'échiquier, prend en paramètres les coordonnées de départ et les coordonnées d'arrivé, et l'échiquier.
};
